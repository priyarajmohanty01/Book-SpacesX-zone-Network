...
import com.book.books.exception.OperationNotPermittedException;
import com.book.books.file.FileStorageService;
import com.book.books.history.BookTransactionHistory;
import com.book.books.history.BookTransactionHistoryRepository;
...
public class BookService {
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        {
            throw new OperationNotPermittedException("The Requested Book cannot be borrowed since it is already archived or borrowed. ");
        }
